    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_img', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='Image')),
            ...
            options={
                'permissions': [('issue', 'can issue the book to a user'), ('return', 'can return the book back to library'), ('renew', 'can renew the book')],
            },
        ),
        migrations.CreateModel(
            name='Borrow',
            fields=[
                ...
                ('issued_by', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='issued_by', to=settings.AUTH_USER_MODEL)),
